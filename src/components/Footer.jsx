/**
 * Footer Компонент - Baaska
 * Вэбсайтын хөл хэсэг: Брэндийн мэдээлэл, сошиал сувгууд болон холбоо барих мэдээллийг агуулна.
 */
...
const Footer = () => {
  const { t, lang } = useLanguage(); // Орчуулгын текстүүд болон идэвхтэй хэлийг авах

  return (
    <footer className="footer">
      {/* Footer-ийн дээд талын алтан туяа бүхий шугам */}
      <div className="footer-divider" />

      <div className="footer-inner container">
        {/* ── 1-р багана: Брэнд болон Сошиал сувгууд ── */}
        ...
        {/* ── 2-р багана: Холбоо барих мэдээлэл ── */}
      ...
      {/* Хамгийн доод хэсэг: Зохиогчийн эрх */}
